<p id="name" style="background-color:#a5c5ff; padding: 10px; color:#2d3436;"><strong>Using Geographic Location-Based Public Health Features in Survival Analysis</strong></p>
...
<p style="color:#636e72;">The <code>code</code> directory contains the Python code used to generate the results in the paper. The <code>data</code> directory contains the datasets used in the analysis.</p>
...
<p style="color:#636e72;">To reproduce the results in the paper, first clone the repository:</p>
